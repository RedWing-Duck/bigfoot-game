...
const T = {
  ...
  room: {   // FIRST (first tour visit), REVISIT (later tour visits), ESCAPE (once the chaos starts)
    ...
    R2: { first: "White marble floors, gold banisters, and two [staircase] that curve up to the same landing like arms around a hug you didn't ask for. The left staircase is wide and carpeted; the right is narrower, polished to a shine. The trophy room glitters west, a piano waits in the salon east, a long table stretches north in the dining hall, the stairs lead up, and the elevator is south.",
      ...
      escape: "The foyer lights flicker. Somewhere above, glass breaks. The two [staircase] rise into the dark; the right one gleams, its thirteenth step catching the emergency light. The gold elevator waits behind you. The trophy cases glitter off to one side, the piano salon to the other, the long dinner table straight ahead." },
    ...
    R4: { first: "A white grand [piano] sits in the middle of the room like the only guest who got a chair. Its lid is a sheet of mirror, and it shows you the chandelier, the ceiling fresco, and your own nervous smile. The foyer is west.",
      ...
      escape: "The [piano] waits in the half-light, its mirrored lid reflecting flashing alarm lights. Mama's piano. Mama's song. The way out is back toward the staircases." },
    ...
    R7: { first: "A long hall of oil portraits, all of them the Don: the Don on a horse, the Don with a lion, the Don as a saint. The wallpaper is peacock feathers. A guard passes by and nods. The atrium is north, the landing east.",
      ...
      escape: "The painted Dons glare down, and one portrait is hanging crooked, torn by claws. Chlorine drifts in from the fountain behind you. Ahead, the balcony at the top of the stairs." },
    R8: { first: "A glass roof, tropical plants, and in the center a bronze [hippo] fountain spouting water from its nostrils with great dignity. Its mouth is closed tight. The gallery is south and a chorus of shrieking birds comes from the north.",
      ...
      escape: "Water sloshes over the fountain's edge. Lemurs chatter in the palms, pelting the floor with fruit. The bronze [hippo] waits, mouth shut. The screaming aviary is behind you; ahead, the hall of portraits." },
    ...
    R10: { first: "A glass room full of peacocks that scream like car alarms with feelings. The [aviary] door has a keypad lock, glowing red. The atrium is south, and fresh night air blows in from the terrace north.",
      ...
      escape: "The [aviary] keypad is smashed, its door rattling. The peacocks are screaming louder than ever. The fresh air of the terrace is behind you; the chlorine smell of the fountain is ahead." },
    R11: { first: "A rooftop garden with a view of the whole city. In a tall yard a giraffe chews thoughtfully; beside it, a black jaguar paces behind the [jaguargate]. Then the alarms start. Lemurs pour out of the dark, a roar shakes the glass, and the Don goes pale: \"The accountant. He opened the big one.\" He's gone south with his guards in three seconds flat. You are alone, holding a plaque proposal, with something enormous waking up to the east.",
      revisit: "Wind, alarms, and the giraffe peering over the [giraffegate]. The jaguar paces behind the [jaguargate]. The broken enclosure gapes to the east; the screaming aviary is behind you." },
  ...
  item: {
    ...
    ledger: { look: "A fat notebook held shut with rubber bands, full of initials, dates, and payments in neat columns. Two pages list nothing but rubber band purchases. Someone had a lot of cash to wrap.",
      take: "You tuck the ledger inside your jacket. Secret one." },
    manifest: { look: "A waterproof tube holding a shipping schedule: dates, ports, and thousands of cans of \"premium chiles\" that clearly have never been near a chile.",
      take: "The manifest goes into your jacket. Secret two." },
    photos: { look: "A stack of photos: the Don shaking hands on a yacht with men whose faces would end careers. Someone wrote a date on the back of each one.",
      take: "You slide the photos into your jacket. Secret three." },
    ...
    staircase: [{ if: { flag: "escape" }, text: "The two staircases rise into the dark; the right one gleams, its thirteenth step catching the emergency light." },
      "The left staircase is wide and carpeted; the right is narrower, polished to a shine."],
    hippo: "A bronze HIPPO fountain spouting water from its nostrils with great dignity. Its mouth is closed tight.",
    aviary: [{ if: { flag: "escape" }, text: "The AVIARY keypad is smashed, its door rattling." }, "The AVIARY door has a keypad lock, glowing red."],
    giraffegate: [{ if: { min: { giraffe: 1 } }, text: "It's already open. That animal's somebody else's problem now." }, "The giraffe peering over the GIRAFFE GATE."],
    jaguargate: [{ if: { min: { jaguar: 1 } }, text: "It's already open. That animal's somebody else's problem now." }, "The jaguar paces behind the JAGUAR GATE."]
  },
  don: {
  ...
  nando: { look: "Nando, the size of a vending machine, blocks the way.",
    ...
    greet: "A flashlight hits your face. Nando, the size of a vending machine, blocks the way. \"Hey. Guests don't wander. Why are you up here?\"",
  ...
  q1: { prompt: "\"So tell me, Walter. Sunday dinner: my mother's pozole or my nonna's Sunday gravy?\"",
    ...
    wrong: "\"You'd choose? In this house?\" He asks again, slower." },
  q2: { prompt: "\"Remind me, what's your bookstore called again?\"",
    right: "\"The Dog-Eared Page. Cute. I like cute.\"",
    wrong: "\"That's not what you told my people.\" He asks again, not smiling." },
  ...
  p1: { solved: "You play the first bars of \"Cielito Lindo,\" badly but with feeling. Something clicks. The mirrored lid rises on its own, and a hidden tray slides out holding a LEDGER bound in rubber bands. Secret one.",
  ...
  p2: { solved: "You flick the coin into Pepita's mouth. The bronze jaw swings open, and a waterproof tube tumbles out into the water. You fish out the SHIPPING MANIFEST. Secret two.",
  ...
  p3: { solved: "You press the thirteenth step. It sinks with a click, and a panel in the staircase slides open, releasing cold air from a narrow passage. Just inside, a shoebox holds the DEAL PHOTOS. Secret three.",
...
const G = {
  ...
  on: {   // global replies (verbs add-on), after the room's own
    ...
    Take: [
      ...
      ...["coin", "ledger", "manifest", "photos"].map(i => ({ if: { said: i === "photos" ? "photos|photo" : i, has: i }, say: T.item[i].take })) ],
